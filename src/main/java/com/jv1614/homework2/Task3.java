...
public class Task3 {
    ...
    public static void main (String [] args) {
        ...
        while (x<11 && y<11 && z<11 && k<11); {
        
        
        if (x<11 && x>0 && y<11 && y>0 && z<11 && z>0 && k<11 && k>0) {
...
"соответствующей насущным потребностям";
        ...
        System.out.print (arrayStrok [x-1][0]);
        System.out.print (arrayStrok [y-1][1]);
        System.out.print (arrayStrok [z-1][2]);
        System.out.print (arrayStrok [k-1][3]);
    }
        else {
